...
//       <h1 className="text-xl font-bold text-gray-800 dark:text-white">Eco-Drop</h1>
//       <ThemeToggle />
//     </nav>
//   )
// }
...
//           <span className="text-xl font-bold text-green-700">Eco-Drop</span>
//         </Link>
...
//             Services
//           </Link>
//           <Link href="/recycling-centers" className="text-sm font-medium hover:text-green-600 transition-colors">
//             Recycling Centers
//           </Link>
...
//                 <Link
//                   href="/"
//                   className="text-base font-medium hover:text-green-600 transition-colors py-2"
...
//                   </Link>
//                 </Button>
//                 <Button asChild className="w-full justify-center bg-green-600 hover:bg-green-700 py-6">
